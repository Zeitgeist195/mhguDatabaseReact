...
class ASBSetAdapter : SimpleDiffRecyclerViewAdapter<ASBSet>() {
    fun areItemsTheSame(oldItem: ASBSet, newItem: ASBSet): Boolean {
        return oldItem.id == newItem.id
    }

    fun areContentsTheSame(oldItem: ASBSet, newItem: ASBSet): Boolean {
    ...
    override fun bindView(viewHolder: SimpleViewHolder, data: Any) {
        TODO("Not yet implemented")
    }

    fun bindView(viewHolder: SimpleViewHolder, data: ASBSet) {
