...
class ArmorSetSummaryFragment : Fragment() {
    ...
    private fun populateArmor(armorPoints: List<ArmorSkillPoints>?){
        ...
        val cellDefense = armors.sumOf { it.defense }.toString() + "~" + armors.sumOf { it.maxDefense }
        ...
        with(binding.armorResits) {
            fireRes.text = armors.sumOf { it.fireRes }.toString()
            waterRes.text = armors.sumOf { it.waterRes }.toString()
            iceRes.text = armors.sumOf { it.iceRes }.toString()
            thunderRes.text = armors.sumOf { it.thunderRes }.toString()
            dragonRes.text = armors.sumOf { it.dragonRes }.toString()
        }
