 ...
 */
abstract class BaseDiffRecyclerViewAdapter<T : Any, VH: RecyclerView.ViewHolder>: BaseListRecyclerView<T, VH>() {
 ...
 */
abstract class SimpleDiffRecyclerViewAdapter<T>: BaseDiffRecyclerViewAdapter<Any, SimpleViewHolder>() {
    protected abstract fun onCreateView(parent: ViewGroup): View
